...
mod iterator {
    use super::{
        Box, ToLeStream, configure_reporting, default_response, read_attributes, report_attributes,
        write_attributes, write_attributes_no_response, write_attributes_undivided,
    };
