...
mod tests {
    ...
    #[test]
    fn test_device_enabled_from_le_stream() {
        let bytes = vec![0x01];
    ...
    #[test]
    fn test_device_disabled_from_le_stream() {
        let bytes = vec![0x00];
        let device_enabled = DeviceEnabled::from_le_stream(bytes.into_iter()).unwrap();
    ...
    #[test]
    fn test_device_enabled_from_le_stream_invalid() {
        let bytes = vec![0x02];
    ...
    #[test]
    fn test_device_enabled_to_le_stream() {
    ...
    #[test]
    fn test_device_disabled_to_le_stream() {
