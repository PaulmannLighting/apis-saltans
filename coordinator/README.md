...
transmission options as required by ZCL. Those unacknowledged responses complete after APS actor
handoff, allowing the page-transfer task to apply the requested response spacing before sending the
next block.
